...
interface IndicateurSuiviModalProps {
    open: boolean
    onOpenChange: (open: boolean) => void
    editData?: any
}

export function IndicateurSuiviFormModal({open, onOpenChange, editData}: IndicateurSuiviModalProps){
    const {
        form,
        onSubmit,
        isPending,
        isEdit,
        indicateurs
    } = useReleveForm(open, onOpenChange, editData)
