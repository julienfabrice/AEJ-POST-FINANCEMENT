...
import { useDecaissementDeclarationForm } from '../hooks/useDecaissementDeclarationForm'
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[520px] max-h-[90vh] overflow-y-auto">
        <DialogHeader><DialogTitle>{isEdit ? 'Modifier la' : 'Nouvelle'} déclaration de décaissement</DialogTitle></DialogHeader>
        <Form {...form}>
