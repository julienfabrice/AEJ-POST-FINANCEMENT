...
export function usePlanDecaissementViewerModal() {
  const { sigle_monnaie_pays } = useConfigStore()
  const projet = useProjetsStore(s => s.planDecaissementViewerProjet)
  ...
  const handleClose = () => setPlanDecaissementViewerProjet(null)
